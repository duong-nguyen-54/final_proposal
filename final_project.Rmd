...
#### Low Birth Weight Rate vs. Annual pm 2.5 Concentration 
...
$ \text{low birth weight} = 11.53 - 0.11(\text{median age}) + 8.05 (\text{percent_non_hisp_black})$
...
$ \text{premature birth weight} = 4.88 + 0.08(\text{median age}) + 8.03 (\text{percent_non_hisp_black})$
...
$ \text{cancer mortality rate} = -1.85 + 13.27(\text{annual pm 2.5}) + 13.14(\text{median age}) - 213.49(\text{percent high income}) + 464.03(\text{percent non hisp white}) + 536.28(\text{percent non hisp black}) +  1023.82(\text{percent hisp white}) - 1787.43(\text{percent hisp black}) - 574.15(\text{percent male})$
